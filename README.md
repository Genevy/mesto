...
## Функционал
* Адаптивный дизайн: вэб-сервис адапритован как для стационарных ПК так и для мобильных устройств.
* Реакция на действия пользователя с применением JavaScript:
 * возможность изменения аватара пользователь,
 * возможность изменения данных пользователя,
 * возмодеость добавления новых изображение,
